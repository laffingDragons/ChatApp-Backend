...
## Getting Started
### Documentation
#### [Apidoc](http://node-chat-doc.akshaypatil.online/)
#### [Eventdoc](http://node-chat-eventdoc.akshaypatil.online/)       
...
```
```
3. git remote add origin https://github.com/laffingDragons/ChatApp-Backend.git
```
```
...
13. node app.js
```
14. Your project should be running on localhost.


## Deployed at

`http://node-chat.akshaypatil.online/`
